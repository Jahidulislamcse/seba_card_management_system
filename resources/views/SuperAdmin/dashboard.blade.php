...
@section('content')
            ...
            <div class="all-cards">
                ...
                <div class="cards">
                    <a class="card-links" href="CardRequest.html">
                        <div>
                ...
                <div class="cards">
                    <a class="card-links" href="UserCreate.html">
                        <div>
                ...
                <div class="cards">
                    <a class="card-links" href="OfferSetting.html">
                        <div>
                ...
                <div class="cards">
                    <a class="card-links" href="NoticeSetting.html">
                        <div>
                            <img src="{{ asset('SuperAdmin/assets/img/notice.png')}}" alt="notice icon">
                        </div>
                    </a>
